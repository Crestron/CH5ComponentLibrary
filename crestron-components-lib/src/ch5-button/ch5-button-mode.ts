...
import { ICh5ButtonModeAttributes } from "./interfaces/i-ch5-button-mode-attributes";
import { TCh5ButtonType } from "./interfaces";
...
export class Ch5ButtonMode extends Ch5Common implements ICh5ButtonModeAttributes {
    ...
    public set type(value: TCh5ButtonType) {
        ...
        if (this._type !== value && value !== null) {
            ...
            const parentElement = this.getParentButton();
            if (parentElement !== null) {
                parentElement.setAttribute("type", this._type);
            }
        }
    }
    ...
    public getParentButton(): Ch5Button | null {
    ...
    // get selected() {
    //     this.info('Ch5ButtonMode get selected()');

    //     return this.hasAttribute('selected');
    // }

    // set selected(value) {
    //     this.info('Ch5ButtonMode set selected()');
    ...
    public connectedCallback() {
        this.info('Ch5ButtonMode.connectedCallback()');
    ...
    public disconnectedCallback() {
        this.info('Ch5ButtonMode.disconnectedCallback()');
    ...
    public attributeChangedCallback(attr: string, oldValue: string, newValue: string) {
        ...
        switch (attr) {
            ...
            //     this.noshowType = Ch5ButtonMode.SHOW_TYPES[0];
            //     break;
            // case 'show':
    ...
    //     this.info('Ch5ButtonMode._sendSignalValueOnShow()');
