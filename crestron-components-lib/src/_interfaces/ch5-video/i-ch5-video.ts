 ...
 *      "description": "Provides a view onto a streaming video window. Components that are to reside above the video that need to be visible and active, examples include buttons to control playback, text describing the video, and annotation controls, need to be defined as children elements to this component.",
 *      "body": [
 *        "<ch5-video indexid=\"${1}\" aspectratio=\"${2:16:9}\" controls=\"${3:false}\" size=\"${4:large}\" sourcetype=\"${5:Network}\" userid=\"${6}\" snapshotuserid=\"${7}\" password=\"${8}\" snapshotpassword=\"${9}\" snapshoturl=\"${10}\" url=\"${11}\" stretch=\"${12:false}\" zindex=\"${13:0}\" snapshotrefreshrate=\"${14:0}\" scrollcontainerid=\"${15}\" receivestatesourcetype=\"${16}\" receivestateuserid=\"${17}\" receivestatepassword=\"${18}\" receivestatesnapshoturl=\"${19}\" receivestatesnapshotrefreshrate=\"${20}\" receivestatesnapshotuserid=\"${21}\" receivestatesnapshotpassword=\"${22}\" receivestateplay=\"${23}\" receivestateselect=\"${24}\" receivestateurl=\"${25}\" receivestatevideocount=\"${26}\" sendeventonclick=\"${27}\" sendeventstate=\"${28}\" sendeventselectionurl=\"${29}\" sendeventerrorcode=\"${30}\" sendeventerrormessage=\"${31}\" sendeventsnapshoturl=\"${32}\" sendeventselectionsourcetype=\"${33}\" sendeventselectionchange=\"${34}\" sendeventretrycount=\"${35}\" sendeventsnapshotlastupdatetime=\"${36}\" sendeventresolution=\"${37}\" sendeventsnapshotstatus=\"${38}\">",
 *         "</ch5-video>$0"
 *        ] 
 *    }
 * ]
