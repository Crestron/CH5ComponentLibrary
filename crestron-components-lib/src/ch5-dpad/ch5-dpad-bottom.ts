...
import { ICh5DpadBottomAttributes } from "./interfaces/i-ch5-dpad-bottom-interfaces";
...
export class Ch5DpadBottom extends Ch5Common implements ICh5DpadBottomAttributes {
    private COMPONENT_NAME: string = "ch5-dpad-bottom";
    ...
    public readonly primaryCssClass = 'ch5-dpad-bottom';
    public readonly cssClassPrefix = 'ch5-dpad-bottom';
    ...
    public connectedCallback() {
        ...
        customElements.whenDefined('ch5-dpad-bottom').then(() => {
    ...
    public attributeChangedCallback(attr: string, oldValue: string, newValue: string) {
        ...
        this.info('ch5-dpad-bottom attributeChangedCallback("' + attr + '","' + oldValue + '","' + newValue + '")');
...
if (typeof window === "object"
    ...
    window.customElements.define('ch5-dpad-bottom', Ch5DpadBottom);
}