...
export class Ch5DpadTop extends Ch5Common implements ICh5DpadTopAttributes {
    ...
    private updateContractSpecificKeys_Show() {
        ...
        const rightBtnContractShow = CH5DpadContractUtils.getTopBtnContract().TopShow;
    ...
    private updateContractSpecificKeys_Enable() {
        ...
        const rightBtnContractEnable = CH5DpadContractUtils.getTopBtnContract().TopEnable;
