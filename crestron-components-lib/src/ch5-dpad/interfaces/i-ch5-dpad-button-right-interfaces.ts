 ...
 * @name Ch5 Dpad Right
 * @isattribute false
 * @tagName ch5-Dpad Right
 * @role container
 * @description Ch5 Dpad Right
 * @componentVersion 1.0.0
 * @documentation
 * [
 * "`ch5-dpad-right` element",
 * "***",
 * "DPad <ch5-dpad-right> component"
 * ]
 * @snippets
 * [
 * ]
...
export interface ICh5DpadRightAttributes extends ICh5CommonAttributes {
