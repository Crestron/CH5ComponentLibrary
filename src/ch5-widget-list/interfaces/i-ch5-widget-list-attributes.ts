import { ICh5CommonAttributesForAppendClassWhenInViewPort } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-appendclasswheninviewport";
import { ICh5CommonAttributesForCustomClass } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-customclass";
import { ICh5CommonAttributesForCustomStyle } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-customstyle";
...
import { ICh5CommonAttributesForReceiveStateCustomClass } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-receivestatecustomclass";
import { ICh5CommonAttributesForReceiveStateCustomStyle } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-receivestatecustomstyle";
import { ICh5CommonAttributesForReceiveStateEnable } from "../../ch5-common/interfaces/common/i-ch5-common-attributes-receivestateenable";
...
import { TCh5WidgetListAttributesLoadItems, TCh5WidgetListOrientation, TCh5WidgetListStretch, } from './t-ch5-widget-list';

/**
 * @ignore
 */
export interface ICh5WidgetListAttributes extends ICh5CommonAttributesForDir,
...
ICh5CommonAttributesForId {
  ...
  */
  orientation: TCh5WidgetListOrientation;
  /**
   * @documentation
   * [
  ...
  */
   ...
   * @attributeType "EnumeratedValue"
   */
  stretch: TCh5WidgetListStretch | null;
   ...
   * "`indexId` attribute",
   * "***",
   * "This attribute helps to replace the pattern with the index on the ch5-widget-list"
   * ]
   * @name indexid
   * @attributeType "String"
   */
   ...
   */
  loadItems: TCh5WidgetListAttributesLoadItems;
