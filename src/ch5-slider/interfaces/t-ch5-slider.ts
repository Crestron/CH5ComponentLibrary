...
export type TCh5SliderHorizontalAlignLabel = 'left' | 'right' | 'center';

export type TCh5SliderType = 'default' | 'primary' | 'info' | 'text' | 'danger' | 'warning' | 'success' | 'secondary';

export type TCh5SliderVerticalAlignLabel = 'middle' | 'top' | 'bottom';
