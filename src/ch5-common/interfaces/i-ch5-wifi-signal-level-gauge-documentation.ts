...
import { ICh5WifiSignalLevelGaugeCommonAttributes } from "./i-ch5-wifi-signal-level-gauge-attributes";

/**
 * @ignore
 */
export interface ICh5WifiSignalLevelGaugeCommonDocumentation extends ICh5CommonForDisabled,
	ICh5CommonForDebug,
	ICh5CommonForRole,
	ICh5CommonForStyle,
	ICh5CommonForClass,
	ICh5WifiSignalLevelGaugeCommonAttributes {
