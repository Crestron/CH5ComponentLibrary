...
import { ICh5ModalDialogCommonAttributes } from "./i-ch5-modal-dialog-attributes";

/**
 * @ignore
 */
export interface ICh5ModalDialogCommonDocumentation extends ICh5CommonForDisabled,
	ICh5CommonForDebug,
	ICh5CommonForRole,
	ICh5CommonForStyle,
	ICh5CommonForClass,
	ICh5ModalDialogCommonAttributes {
