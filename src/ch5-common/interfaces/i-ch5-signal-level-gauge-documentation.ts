...
import { ICh5SignalLevelGaugeCommonAttributes } from "./i-ch5-signal-level-gauge-attributes";

/**
 * @ignore
 */
export interface ICh5SignalLevelGaugeCommonDocumentation extends ICh5CommonForDisabled,
	ICh5CommonForDebug,
	ICh5CommonForRole,
	ICh5CommonForStyle,
	ICh5CommonForClass,
	ICh5SignalLevelGaugeCommonAttributes {
