...
import { ICh5CommonAttributesHtmlDiv } from "./i-ch5-common-attributes-html-div";

/**
 * @ignore
 */
export interface ICh5CommonHtmlDiv extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5CommonAttributesHtmlDiv {
