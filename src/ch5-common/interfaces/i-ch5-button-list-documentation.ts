...
import { ICh5ButtonListCommonAttributes } from "./i-ch5-button-list-attributes";

/**
 * @ignore
 */
export interface ICh5ButtonListCommonDocumentation extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5ButtonListCommonAttributes {
