...
import { ICh5CommonAttributesLegacyMediaPlayerMyMusic } from "./i-ch5-common-attributes-legacy-media-player-my-music";

/**
 * @ignore
 */
export interface ICh5CommonLegacyMediaPlayerMyMusic extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5CommonAttributesLegacyMediaPlayerMyMusic {
