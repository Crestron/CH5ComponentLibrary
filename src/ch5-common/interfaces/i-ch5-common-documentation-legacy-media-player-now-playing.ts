...
import { ICh5CommonAttributesLegacyMediaPlayerNowPlaying } from "./i-ch5-common-attributes-legacy-media-player-now-playing";

/**
 * @ignore
 */
export interface ICh5CommonLegacyMediaPlayerNowPlaying extends ICh5CommonForDisabled, ICh5CommonForDebug, ICh5CommonForRole, ICh5CommonForStyle, ICh5CommonForClass, ICh5CommonAttributesLegacyMediaPlayerNowPlaying {
