 ...
 * @ignore
 */
export interface ICh5CommonAttributesLegacyMediaPlayerMyMusic extends ICh5CommonAttributesForDir, ICh5CommonAttributesForShow, ICh5CommonAttributesForId { }
