export interface MyMpObject {
    ...
    registrationMsgId: number;
    getObjectsMsgId: number;
    registerEventMsgId: number;
    getPropertiesSupportedMsgId: number;
    getMenuMsgId: number;
    getRegisterBusyChangedId: number;
    getRegisterStatusMsgChangedId: number;
    getRegisterStateChangedByBrowseContextId: number;
    getRegisterStateChangedId: number;
    getTextLinesId: number;
    getActionsSupportedId: number;
    getProgressBarId: number;
    getElapsedSecId: number;
    getTrackSecId: number;
    getStreamStateId: number;
    getTrackNumId: number;
    getTrackCntId: number;
    getPlayerStateId: number;
    getPlayerIconId: number;
    getPlayerNameId: number;
    getPlayerIconURLId: number;
    getMediaTypeId: number;
    getInstanceId: number;
    getAlbumArtId: number;
    getAlbumArtUrlId: number;
    getAlbumArtUrlNATId: number;
    getStationNameId: number;
    getAlbumId: number;
    getGenreId: number;
    getArtistId: number;
    getTitleId: number;
    getLanguageId: number;
    getRewindSpeedId: number;
    getProviderNameId: number;
    getFfwdSpeedId: number;
    getNextTitleId: number;
    getMediaReadyId: number;
    getShuffleStateId: number;
    getRepeatStateId: number;
    getStatusMsgId: number;
    getBusyId: number;
    getRatingId: number;
    getSelectedId: number;
    getVersionId: number;
    getMaxReqItems: number;
    getLevelId: number;
    getItemCntId: number;
    getSubtitleId: number;
    getIsMenuAvailableId: number;
    getStatusMsgMenuId: number;
    getListSpecificFunctionsId: number;
    getMaxReqItemsId: number;
    getItemDataId: number;
    getItemData2Id: number;
    getActionsAvailableId: number;
    getRegisterClearChangedId: number;
    getRegisterListChangedId: number;
    getRegisterStatusMsgMenuChangedId: number;
    resetId: number;
