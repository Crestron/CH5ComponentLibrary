 ...
 *      "body": [
 *        "<ch5-video indexid=\"${1}\" aspectratio=\"${2:16:9,4:3}\" controls=\"${3:true,false}\" size=\"${4:x-small,small,large,x-large,xx-large}\" sourcetype=\"${5:Network,HDMI,DM}\" userid=\"${6}\" snapshotuserid=\"${7}\" password=\"${8}\" snapshotpassword=\"${9}\" snapshoturl=\"${10}\" url=\"${11}\" stretch=\"${12:true,false}\" zindex=\"${13}\" snapshotrefreshrate=\"${14}\">",
 *         "</ch5-video>$0"
 *        ]
 *    },
 *    {
 ...
 *      "description": "Provides a view onto a streaming video window. Components that are to reside above the video that need to be visible and active, examples include buttons to control playback, text describing the video, and annotation controls, need to be defined as children elements to this component.",
 *      "body": [
 *        "<ch5-video indexid=\"${1}\" aspectratio=\"${2:16:9,4:3}\" controls=\"${3:true,false}\" size=\"${4:x-small,small,large,x-large,xx-large}\" sourcetype=\"${5:Network,HDMI,DM}\" userid=\"${6}\" snapshotuserid=\"${7}\" password=\"${8}\" snapshotpassword=\"${9}\" snapshoturl=\"${10}\" url=\"${11}\" stretch=\"${12:true,false}\" receivestateselect=\"${13}\" receivestatevideourl=\"${14}\" receivestatepositionchange=\"${15}\" receivestatesourcetype=\"${16}\" receivestateuserid=\"${17}\" receivestatepassword=\"${18}\" receivestatesnapshoturl=\"${19}\" receivestatesnapshotrefreshrate=\"${20}\" receivestatesnapshotuserid=\"${21}\" receivestatesnapshotpassword=\"${22}\" receivestateplay=\"${23}\" zindex=\"${24}\" snapshotrefreshrate=\"${25}\" receivestatevideocount=\"${26}\">",
 *         "</ch5-video>$0"
 *        ] 
 *    }
 * ]
