...
export class ConsoleDebugger {
    ...
    public static log(message?: any, ...optionalParams: any[]): void {
        this.logInternal(DebugConfiguration.shouldPrintToConsole(), message, optionalParams);
    }

    public static error(message?: any, ...optionalParams: any[]): void {
        this.errorInternal(DebugConfiguration.shouldPrintToConsole(), message, optionalParams);
    }
    ...
    private static logInternal(debug: boolean, message?: any, optionalParams?: any[]): void {
        if (debug) {
            ...
            console.log(DebugConfiguration.NEWLINE);
        }
    }
    ...
    private static errorInternal(debug: boolean, message?: any, optionalParams?: any[]): void {
        if (debug) {
            ...
            console.error(DebugConfiguration.NEWLINE);
        }
    }
