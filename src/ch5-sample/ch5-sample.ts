...
export class Ch5Sample extends Ch5Common implements ICh5SampleAttributes {
  ...
  public static readonly SIGNAL_ATTRIBUTE_TYPES: Ch5SignalElementAttributeRegistryEntries = {
    ...
    sendeventselectionchange: { direction: "state", numericJoin: 1, contractName: true },
    sendeventselectionsourcetype: { direction: "state", stringJoin: 1, contractName: true },
    sendeventselectionurl: { direction: "state", stringJoin: 1, contractName: true },
    sendeventsnapshoturl: { direction: "state", stringJoin: 1, contractName: true },
    sendeventstate: { direction: "state", numericJoin: 1, contractName: true },
    sendeventerrorcode: { direction: "state", numericJoin: 1, contractName: true },
    sendeventerrormessage: { direction: "state", stringJoin: 1, contractName: true },
    sendeventretrycount: { direction: "state", numericJoin: 1, contractName: true },
    sendeventresolution: { direction: "state", stringJoin: 1, contractName: true },
    sendeventsnapshotstatus: { direction: "state", numericJoin: 1, contractName: true },
    sendeventsnapshotlastupdatetime: { direction: "state", stringJoin: 1, contractName: true },
