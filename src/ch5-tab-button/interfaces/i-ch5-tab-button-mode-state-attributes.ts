import { TCh5ButtonListButtonType, TCh5ButtonListButtonHAlignLabel, TCh5ButtonListButtonVAlignLabel, TCh5ButtonListButtonCheckboxPosition, TCh5ButtonListButtonIconPosition, TCh5ButtonListButtonModeState } from "../../ch5-button-list/interfaces/t-ch5-button-list";

/**
 * @ignore
 */
export interface ICh5TabButtonModeStateAttributes {
  /**
  * @documentation
  * [
  * "`state` attribute",
  ...
  * "***",
  * "defines custom class for the tab button mode"
  * ]
  * @name customclass
  * @default 
  * @attributeType "String"
  ...
  * "***",
  * "defines custom style for the tab button mode"
  * ]
  * @name customstyle
  * @default 
  * @attributeType "String"
