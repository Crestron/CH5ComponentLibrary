 ...
 * @isattribute false
 * @tagName ch5-Dpad Bottom
 * @role container
 * @description Ch5 Dpad Bottom
 * @componentVersion 1.0.0
 * @documentation
 * [
 * "`ch5-dpad-bottom` element",
 * "***",
 * "DPad <ch5-dpad-bottom> component"
 * ]
 * @snippets
 * [
 * ]
...
export interface ICh5DpadBottomAttributes extends ICh5CommonAttributes {
