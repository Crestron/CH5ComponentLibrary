...
import { ICh5DpadRightAttributes } from "./interfaces/i-ch5-dpad-right-interfaces";
...
export class Ch5DpadRight extends Ch5Common implements ICh5DpadRightAttributes {
    ...
    public readonly primaryCssClass = 'ch5-dpad-right';
    public readonly cssClassPrefix = 'ch5-dpad-right';
    ...
    public connectedCallback() {
        ...
        customElements.whenDefined('ch5-dpad-right').then(() => {
    ...
    public attributeChangedCallback(attr: string, oldValue: string, newValue: string) {
        ...
        this.info('ch5-dpad-right attributeChangedCallback("' + attr + '","' + oldValue + '","' + newValue + '")');
...
if (typeof window === "object"
    ...
    window.customElements.define('ch5-dpad-right', Ch5DpadRight);
}