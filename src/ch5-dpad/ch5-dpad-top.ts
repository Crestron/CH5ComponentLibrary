...
import { ICh5DpadTopAttributes } from "./interfaces/i-ch5-dpad-top-interfaces";
...
export class Ch5DpadTop extends Ch5Common implements ICh5DpadTopAttributes {
    ...
    public readonly primaryCssClass = 'ch5-dpad-top';
    public readonly cssClassPrefix = 'ch5-dpad-top';

    //#endregion

    //#region 1.2 private / protected variables
    private COMPONENT_NAME: string = "ch5-dpad-top";
    ...
    public connectedCallback() {
        ...
        customElements.whenDefined('ch5-dpad-top').then(() => {
    ...
    public attributeChangedCallback(attr: string, oldValue: string, newValue: string) {
        ...
        this.info('ch5-dpad-top attributeChangedCallback("' + attr + '","' + oldValue + '","' + newValue + '")');
...
if (typeof window === "object"
    ...
    window.customElements.define('ch5-dpad-top', Ch5DpadTop);
}